...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_viewDidLoad_showLoadingIndicator() {
        ...
        XCTAssertFalse(sut.isShowingLoadingIndicator, "Expected no loading indicator once view is loading completes successfully")
    ...
    func test_feedImageView_loadsImageURLWhenVisible() {
        let image0 = makeImage(location: "http://url-0.com")
        let image1 = makeImage(location: "http://url-1.com")
        let (sut, loader) = makeSUT()
    ...
    func test_feedImageView_cancelsImageLoadingWhenNotVisibleAnymore() {
        ...
        XCTAssertEqual(loader.canceledImageURLs, [image0.url, image1.url], "Expected two cancelled image URL requests once second image is not visible anymore")
    }
